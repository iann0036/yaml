import { j as _inherits, k as _createSuper, b as _classCallCheck, T as Type, a as _createClass, R as Range, N as Node, h as YAMLSemanticError, l as _get, m as _getPrototypeOf, Y as YAMLSyntaxError, C as Char, c as _defineProperty, P as PlainValue } from './PlainValue-3b27f0e5.js';
  ...
  _createClass(Comment, [{
    ...
    value: function toString() {
      var _this$context = this.context,
          ...
          atLineStart = _this$context.atLineStart,
          indent = _this$context.indent,
          range = this.range,
          value = this.value;
      if (value != null) return value;
      var str = '';
      if (atLineStart) for (var i = 0; i < indent; ++i) {
        str += ' ';
      }
  ...
  _createClass(Collection, [{
    ...
    value: function toString() {
      var src = this.context.src,
          ...
          range = this.range,
          value = this.value,
          overrideStartStr = this.overrideStartStr;
      if (value != null) return value;
